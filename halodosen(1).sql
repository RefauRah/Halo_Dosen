...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2018 at 01:20 AM
...
ALTER TABLE `jadwal`
  ...
  ADD CONSTRAINT `FK_RELATIONSHIP_6` FOREIGN KEY (`NIP`) REFERENCES `dosen` (`NIP`);
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `FK_RELATIONSHIP_7` FOREIGN KEY (`NIP`) REFERENCES `dosen` (`NIP`),
...
--
ALTER TABLE `subscribe`
  ADD CONSTRAINT `FK_RELATIONSHIP_3` FOREIGN KEY (`NIM`) REFERENCES `mahasiswa` (`NIM`),
  ADD CONSTRAINT `FK_RELATIONSHIP_9` FOREIGN KEY (`NIP`) REFERENCES `dosen` (`NIP`),
